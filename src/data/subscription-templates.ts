...
export const subscriptionTemplates: SubscriptionTemplate[] = [
  ...
  // ─── Claude (Anthropic) ────────────────────────────────────
  {
    ...
    color: '#D97757',
    plans: [
      { name: 'Pro', price: 20.00, billingCycle: 'monthly' },
      { name: 'Pro (Annual)', price: 17.00, billingCycle: 'monthly' },
      { name: 'Max 5x', price: 100.00, billingCycle: 'monthly' },
      { name: 'Max 20x', price: 200.00, billingCycle: 'monthly' },
    ],
  },
  ...
  // ─── Duolingo ──────────────────────────────────────────────
  {
    ...
    plans: [
      ...
      { name: 'Super (Annual)', price: 84.00, billingCycle: 'yearly' },
      ...
      { name: 'Family (Annual)', price: 120.00, billingCycle: 'yearly' },
    ],
  },
  ...
  // ─── Google One ────────────────────────────────────────────
  {
    ...
    plans: [
      ...
      { name: 'AI Premium (2 TB + Gemini Advanced)', price: 19.99, billingCycle: 'monthly' },
    ],
  },
]
